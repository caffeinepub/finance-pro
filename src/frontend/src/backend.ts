...
export class Backend implements backendInterface {
    ...
    async addOrUpdateCustomer(arg0: Customer): Promise<void> {
        if (this.processError) {
            try {
    ...
    async addOrUpdateEMIPayment(arg0: EMIPayment): Promise<void> {
        if (this.processError) {
            try {
    ...
    async deleteEMIPayment(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getEMIPayments(): Promise<Array<EMIPayment>> {
        if (this.processError) {
            try {
                const result = await this.actor.getEMIPayments();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
